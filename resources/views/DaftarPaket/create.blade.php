...
@error('paket') is-invalid @enderror" placeholder="Id Paket Wisata" id="paket" name="paket" value="{{old('paket')}}" aria-label="Id Paket Wisata" aria-describedby="cari" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control
@error('jumlah_pelanggan') is-invalid @enderror" id="jumlah_pelanggan" placeholder="Jumlah Pelanggan" name="jumlah_pelanggan" value="{{old('jumlah_pelanggan')}}">
                        @error('jumlah_pelanggan') <span class="textdanger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="harga_paket">Harga Paket</label>
                        <input type="text" class="form-control
@error('harga_paket') is-invalid @enderror" id="harga_paket" placeholder="Harga Paket" name="harga_paket" value="{{old('harga_paket')}}">
